...
-   EDA is 2026 should ideally be interactive and leverage AI tools.
...
-   Learning to explore data without a defined 'the right answer' helps build confidence and creative thing skills.
...
- Data were aggregated from Box Office Mojo and filtered to six largest U.S. distributors from 2016 to 2015.
...
**This is a quick demonstration but in a classroom setting the students will be asked to follow through with:**

  - careful use of group means comparisons.
  
  - additional plots to illustrate specific findings
  
  - consideration of how to augment data to ask follow up questions.
  
  - clearly communicating finding and a follow up analysis plan.
...
- my colleagues and my students who inspire me with thoughtful questions that have helped this development process.
